    ...
    <div class="signin"> 
        ...
        <div class="content"> 
            ...
            <form action="connect.php" method="post" autocomplete="off">
                    ...
                    <input type="text" name="username" required autocomplete="off"> <i>Login</i> 
                    
                </div> 
                
                <div class="inputBox"> 
                    
                    <input type="password" name="password" required autocomplete="new-password"> <i>Senha</i> 
                    
                </div> 
                
                <div class="links"> <a href="#">Esqueci a senha</a> <a href="../cadastro/signup.html">Cadastrar</a> 
